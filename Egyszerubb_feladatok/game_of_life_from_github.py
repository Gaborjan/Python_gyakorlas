...
def run_game():
    ...
    current_generation[3][5]=1
    current_generation[4][5]=1
    current_generation[5][5]=1
    current_generation[4][4]=1
    current_generation[4][6]=1
    
    for row in range(rows):
        print(current_generation[row], row) 
